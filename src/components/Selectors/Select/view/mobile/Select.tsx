...
const Select = function <TValue = string>({ items, onChange, color = 'default' }: ISelectProps<TValue>) {
  ...
  return (
    <div
      ...
      <div className={b('item-selected')}>
        <div className={b('item-value-selected')}>{activeItem.selectedRenderElement}</div>
