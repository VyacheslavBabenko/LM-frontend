export const common = {
  ...
  accept: 'Confirm',
  reject: 'Reject',
  titlePopUpWithdrawal: "Do you really want to change the user's withdrawal status to -",
  ...
  areYouSureTurnOnBypass: 'Are you sure you want to enable <b>bypass the auto billing system?</b>',
  areYouSureTurnOffBypass: 'Are you sure you want to disable <b>bypassing the auto billing system?</b>',
  areYouSureTurnOnShutDown: 'Are you sure you want to enable <b>emergency shutdown of integrations?</b>',
  areYouSureTurnOffShutDown: 'Are you sure you want to disable <b>emergency shutdown of integrations?</b>',
  ...
  areYouSureBlockWithdrawalUser: 'Do you really want to BAN withdrawals for the user ',
  areYouSureUnBlockWithdrawalUser: 'Do you really want to UNBAN withdrawals for the user ',
