...
import {
	TransferredLeadsState,
	FetchTransferredLeadsParams,
	FetchTransferredLeadsResponse,
} from "./types";
...
export const fetchTransferredLeads = createAsyncThunk<
	FetchTransferredLeadsResponse,
	FetchTransferredLeadsParams
>("transferredLeads/fetchTransferredLeads", async (params) => {
