...
const TransferredLeadsFilters: FC<ITransferredLeadsFilters> = ({ filterState }) => {
      ...
      <FilterHeader
        ...
        <div className={b('second-inputs')}>
          ...
          <div className={b('item')}>
            ...
            <div className={b('item-field')}>
              <SelectFinder items={filterState.values.recipient} onChange={filterState.onChangeRecipient} />
            </div>
          </div>
        </div>
      </FilterHeader>
